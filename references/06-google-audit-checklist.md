# Google Ads Audit Checklist (80 controls)

Source - claude-ads v1.7 line, ads/references/google-audit.md (MIT, AgriciDaniel), as carried in the pro-marketing-ads fork. Use as the execution checklist underneath the six audit prompts. Where a check names a fixed threshold, treat it as a starting default to be replaced by the account's own history after 30 days.
