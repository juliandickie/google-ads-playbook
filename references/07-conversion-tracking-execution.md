# Conversion Tracking Execution Method

Source - claude-ads v2.0.1, ads/references/conversion-tracking.md (MIT, AgriciDaniel). This is the execution method under audit prompt 1.1. The library's rules (one primary action, micro as secondary, backup source within 15 percent, matched windows, 60-second call minimum) are the standard; this file is how you prove the account meets it.
